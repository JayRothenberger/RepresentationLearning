...
def main(rank, world_size):
    ...
    args = {'epochs': 300, 'device': device, 'fp16_precision': False, 'disable_cuda': False, 'temperature': .1, 'n_views': n_views, 'batch_size': batch_size, 'log_every_n_steps': 100, 'arch': 'resnet50'}
    args = Namespace(**args)
